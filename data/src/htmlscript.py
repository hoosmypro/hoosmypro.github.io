...
temp_end0 = """</table>
    ...
    <footer class="text-center">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p>HoosMyProfessor © 2018 v2.1.1. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
...
temp_end1 = """</div>
      ...
      <footer class="text-center">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <p>HoosMyProfessor © 2018 v2.1.2. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
...
<hr>
	<footer class="text-center">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <p>HoosMyProfessor © 2018 v2.1.2 All rights reserved.</p><!--footer-->
            </div>
          </div>
        </div>
      </footer>
...
def generateHTMLClass(file,index,obj,dict,categoryInfo,classDescription):
    ...
    file.write(obj.number + " - " + obj.name + """</h1><!--name-->
		  <a href=""><p>""" + "Instructor's name goes here" + """</p></a><!--instructor-->
    ...
    file.write("""</p><!--课程介绍，来自course forum，不确定和sis上一样不一样-->
		...
		<hr>
          <h7>CourseForum:</h7><a href=""></a>
			<p></p>
		<h7>Lou's List: </h7><a href=""></a>""")
    file.write("""</div>
        <div class="col-md-6 col-sm-12">
          <h2>Rating</h2>
          <hr>
        ...
        file.write("""<div class="col-md-6 col-sm-12 col-lg-12" lang="zh">
          <div class="row">
            ...
            <div class="col-6 offset-lg-1">
              <h5 class="text-left"><span aria-hidden="true"></span>热度: </h5>
            </div>
          </div>
          <h5><span class="badge badge-secondary"></span></h5><!--tag-->
          <p>""")
        file.write(dict[dict[id].instructor].name+":"+dict[id].comment)
        file.write("""</p><!--评价内容-->
          <hr>
			  <hr>
        </div>""")
